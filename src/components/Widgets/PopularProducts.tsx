...
export default function PopularProducts({ products }: PopularProductsProps) {
  return (
    <div className="absolute left-6 top-36 z-20 w-64 mb-6">
      ...
      <div
        className="bg-[rgba(10,10,30,0.2)] backdrop-blur-sm rounded-lg p-3 space-y-2 max-h-[220px] overflow-y-auto scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent hover:scrollbar-thumb-white/30"
        style={{
          scrollbarWidth: 'thin',
