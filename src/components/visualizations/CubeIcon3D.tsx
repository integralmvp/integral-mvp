        ...
        <g transform="translate(50, 40)">
          ...
          {showDimensions && (
            <>
              ...
              {/* 밑판 가로 치수선 (왼쪽 변 - 높이 치수 패턴 시계방향 59도 회전) */}
              <g transform="translate(35, 25) rotate(59)">
                ...
                <text x="8" y="20" fontSize="14" fill="#666" fontWeight="bold" transform="rotate(-59)">250mm</text>
              </g>
              ...
              <g transform="translate(-35, 25) rotate(-59)">
                ...
                {/* 중괄호 */}
                <path d="M -13,0 Q -15,2 -15,5 L -15,31 Q -15,34 -13,36" stroke="#666" strokeWidth="1" fill="none"/>
                <text x="-52" y="20" fontSize="14" fill="#666" fontWeight="bold" transform="rotate(59)">250mm</text>
              </g>
            </>
          )}
        </g>
