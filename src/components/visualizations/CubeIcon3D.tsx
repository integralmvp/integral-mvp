        ...
        <g transform="translate(50, 40)">
          ...
          {showDimensions && (
            <>
              ...
              <g transform="translate(-30, 0) rotate(33.69)">
                ...
                <text x="18" y="20" fontSize="10" fill="#666" fontWeight="bold">250mm</text>
              </g>
              ...
              <g transform="translate(30, 0) rotate(-33.69)">
                ...
                {/* 중괄호 */}
                <path d="M -13,0 Q -15,2 -15,5 L -15,31 Q -15,34 -13,36" stroke="#666" strokeWidth="1" fill="none"/>
                <text x="-42" y="20" fontSize="10" fill="#666" fontWeight="bold">250mm</text>
              </g>
            </>
          )}
        </g>
