        ...
        <g transform="translate(50, 40)">
          ...
          {showDimensions && (
            <>
              ...
              <g transform="translate(40, 30) rotate(63)">
                ...
                <text x="18" y="20" fontSize="14" fill="#666" fontWeight="bold" transform="rotate(-63)">250mm</text>
              </g>

              {/* 밑판 세로 치수선 (오른쪽 변 - 높이 치수 패턴 반시계방향 63도 회전) */}
              <g transform="translate(-40, 30) rotate(-63)">
                <line x1="-8" y1="0" x2="-8" y2="36" stroke="#666" strokeWidth="1" strokeDasharray="2,2"/>
                ...
                {/* 중괄호 */}
                <path d="M -13,0 Q -15,2 -15,5 L -15,31 Q -15,34 -13,36" stroke="#666" strokeWidth="1" fill="none"/>
                <text x="-42" y="20" fontSize="14" fill="#666" fontWeight="bold" transform="rotate(63)">250mm</text>
              </g>
            </>
          )}
        </g>
