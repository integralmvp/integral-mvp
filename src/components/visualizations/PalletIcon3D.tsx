        ...
        <g transform="translate(50, 50)">
          ...
          {showDimensions && (
            <>
              ...
              <g transform="translate(40, 25) rotate(65)">
                ...
                <text x="18" y="25" fontSize="14" fill="#666" fontWeight="bold" transform="rotate(-65)">1100mm</text>
              </g>
              ...
              <g transform="translate(-40, 25) rotate(-65)">
                ...
                {/* 중괄호 */}
                <path d="M -13,0 Q -15,2 -15,5 L -15,40 Q -15,43 -13,45" stroke="#666" strokeWidth="1" fill="none"/>
                <text x="-50" y="25" fontSize="14" fill="#666" fontWeight="bold" transform="rotate(65)">1100mm</text>
              </g>
            </>
          )}
        </g>
