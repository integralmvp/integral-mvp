        ...
        <g transform="translate(50, 50)">
          ...
          {showDimensions && (
            <>
              ...
              {/* 밑판 가로 치수선 (왼쪽 변 - 대각선, 높이 치수 패턴 회전) */}
              <g transform="translate(-40, 0) rotate(26.565)">
                ...
                <text x="18" y="25" fontSize="10" fill="#666" fontWeight="bold">1100mm</text>
              </g>

              {/* 밑판 세로 치수선 (오른쪽 변 - 대각선, 높이 치수 패턴 회전) */}
              <g transform="translate(40, 0) rotate(-26.565)">
                <line x1="-8" y1="0" x2="-8" y2="45" stroke="#666" strokeWidth="1" strokeDasharray="2,2"/>
                ...
                {/* 중괄호 */}
                <path d="M -13,0 Q -15,2 -15,5 L -15,40 Q -15,43 -13,45" stroke="#666" strokeWidth="1" fill="none"/>
                <text x="-50" y="25" fontSize="10" fill="#666" fontWeight="bold">1100mm</text>
              </g>
            </>
          )}
        </g>
