...
import { REGULATION_DEFAULTS } from '../../types/regulationTypes'
import { SPECIAL_HANDLING_CODES, RESTRICTED_CODES } from '../../../infra/dataspec/codedata/items/itemCodes'
...
export function checkRegulation(params: CheckRegulationParams): RegulationDecision {
  ...
  return {
    ...
    signature: {
      ...
      offer: buildOfferRegulationProfile(offer, mode),
      matchedKeys,
    },
  }
}
 ...
 * 공급 상품 시그니처 생성
 */
function buildOfferRegulationProfile(
